...
**The short version:** A four-part health check for any digital product — Data, Avoid Manipulation, Make Intentions Transparent, and Automation — that tells you where the ethical weak spots are and why they're happening.
...
Digital products have a lot of ethical surface area. It's hard to know where to look first, and easy to audit in one area (say, privacy) while missing everything in another (say, manipulation). The Digital Ethics Compass solves this by organizing the audit into four clear categories — ensuring nothing gets skipped by default.
...
- **When you need to present ethical findings to stakeholders who don't speak ethical design language** — the four categories are accessible and concrete
...
Before working through the four categories, the compass requires three structural artifacts. Without them, the analysis stays abstract.
...
Then the compass covers its four categories:

**Data:** Collection, use, storage, sharing. Proportionate to value delivered? Do users understand what they're agreeing to?

**Avoid Manipulation:** Dark patterns, attention exploitation, fear triggers, social pressure. Where is design serving the system at the expense of users?

**Make Intentions Transparent:** Does the product tell users what it's doing and why? Are algorithmic decisions explained? Is pricing honest? Are conflicts disclosed?

**Automation:** Where does the product make decisions for users? Is human judgment available when automation fails? Are assumptions documented?

For each category, the audit identifies:
...
Describe your product — what it does, how it makes money, key features, ethical situation. Ask for a Digital Ethics Compass audit. The AI will produce the Stakeholder & Power Map, Objective Function Risk Table, and Non-Obvious Harms Inventory first, then work through all four categories referencing the named stakeholders, rate severity, and attribute each failure to the business pressure driving it.
...
**Make Intentions Transparent findings 🟡:**
...
- [Humane Design Guide](humane-design-guide.md) — six-sensitivity audit for psychological harm; pairs with the Avoid Manipulation category
- [Responsible Design Prism](responsible-design-prism.md) — gives an overall ethical posture rating; the Compass breaks down, category by category, where that posture fails
